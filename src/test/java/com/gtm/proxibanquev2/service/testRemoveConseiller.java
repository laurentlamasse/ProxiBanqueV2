...
public class testRemoveConseiller {
	...
	@Test
	public void testRemoveConseilleBase() {
		
		conseillertest = new Conseiller("Jean", "Hubert", 89, "plop", "plip");
		...
		assertTrue("Test d'ajout d'un client", consDAO.removeConseilleBase(conseillertest));
	}
